...
for idx, img_file in enumerate(image_files):
    ...
    with col1:
        st.image(os.path.join(original_path, img_file), caption="Original")
        
    with col2:
        st.image(os.path.join(sketch_path, img_file), caption="Sketch")
    ...
    with col4:
        st.image(os.path.join(edited_path, img_file), caption="Edited")
        
    with col5:
        st.image(os.path.join(gt_path, img_file), caption="Ground Truth")
